...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SeriesContent'
        db.create_table('series_seriescontent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('self_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='series_contents_lt', to=orm['contenttypes.ContentType'])),
            ('self_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('other_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='series_contents_rt', to=orm['contenttypes.ContentType'])),
            ('other_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True)),
        ))
        db.send_create_signal('series', ['SeriesContent'])

        # Adding model 'Series'
        db.create_table('series_series', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250, db_index=True)),
            ('slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from=None, unique_with=(), blank=True)),
    ...
    def backwards(self, orm):
        # Deleting model 'SeriesContent'
        db.delete_table('series_seriescontent')
    ...
    models = {
        ...
        'series.series': {
            'Meta': {'ordering': "['-creation_date']", 'object_name': 'Series'},
