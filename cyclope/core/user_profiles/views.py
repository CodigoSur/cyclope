...
brought into cyclope in order to upgrade syntax to django >= 1.9
...
def create_profile(request, form_class=None, success_url=None,
    ...
    :view:`cyclope.core.user_profiles.views.edit_profile` view.
    ...
    **Optional arguments:**
    ...
    ``form_class``
        ...
        ``ModelForm`` automatically generated from the model.
    
    ``success_url``
        The URL to redirect to after successful profile creation. If
        this argument is not supplied, this will default to the URL of
        :view:`cyclope.core.user_profiles.views.profile_detail` for the newly-created
        profile object.
...
def edit_profile(request, form_class=None, success_url=None,
    ...
    If the user does not already have a profile, a redirect will be issued to the
    :view:`cyclope.core.user_profiles.views.create_profile` view.
    ...
    **Optional arguments:**
    ...
    ``success_url``
        ...
        :view:`cyclope.core.user_profiles.views.profile_detail` for the profile object
        being edited.
