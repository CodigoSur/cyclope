...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Categorization.order'
        db.alter_column('collections_categorization', 'order', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Categorization.order'
        db.alter_column('collections_categorization', 'order', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        'collections.categorization': {
            ...
            'order': ('django.db.models.fields.FloatField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'})
        },
