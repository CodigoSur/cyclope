...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.show_author'
        db.add_column('cyclope_sitesettings', 'show_author',
                      self.gf('django.db.models.fields.CharField')(default='AUTHOR', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteSettings.show_author'
        db.delete_column('cyclope_sitesettings', 'show_author')
