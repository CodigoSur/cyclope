...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegionView.view_options'
        db.add_column('cyclope_regionview', 'view_options', self.gf('jsonfield.fields.JSONField')(default='{}'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RegionView.view_options'
        db.delete_column('cyclope_regionview', 'view_options')
