...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cyclope_relatedcontent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('self_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_contents_lt', to=orm['contenttypes.ContentType'])),
            ('self_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('other_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_contents_rt', to=orm['contenttypes.ContentType'])),
            ('other_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal('cyclope', ['RelatedContent'])


    def backwards(self, orm):

        # Deleting model 'RelatedContent'
        db.delete_table('cyclope_relatedcontent')
