...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.enable_abuse_reports'
        db.add_column('cyclope_sitesettings', 'enable_abuse_reports',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'SiteSettings.newsletter_collection'
        db.alter_column('cyclope_sitesettings', 'newsletter_collection_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collections.Collection'], null=True, on_delete=models.SET_NULL))

        # Changing field 'SiteSettings.default_layout'
        db.alter_column('cyclope_sitesettings', 'default_layout_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Layout'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting field 'SiteSettings.enable_abuse_reports'
        db.delete_column('cyclope_sitesettings', 'enable_abuse_reports')


        # Changing field 'SiteSettings.newsletter_collection'
        db.alter_column('cyclope_sitesettings', 'newsletter_collection_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collections.Collection'], null=True))

        # Changing field 'SiteSettings.default_layout'
        db.alter_column('cyclope_sitesettings', 'default_layout_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Layout'], null=True))
