...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layout.image_path'
        db.add_column('cyclope_layout', 'image_path',
                      self.gf('django.db.models.fields.CharField')(default='layout/main.png', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layout.image_path'
        db.delete_column('cyclope_layout', 'image_path')
    ...
    models = {
        ...
        'cyclope.layout': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_path': ('django.db.models.fields.CharField', [], {'default': "'layout/main.png'", 'max_length': '100'}),
