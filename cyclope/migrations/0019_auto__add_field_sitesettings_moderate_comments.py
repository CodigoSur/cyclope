...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.moderate_comments'
        db.add_column('cyclope_sitesettings', 'moderate_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteSettings.moderate_comments'
        db.delete_column('cyclope_sitesettings', 'moderate_comments')
