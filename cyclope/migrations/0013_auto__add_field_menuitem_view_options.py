...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MenuItem.view_options'
        db.add_column('cyclope_menuitem', 'view_options', self.gf('jsonfield.fields.JSONField')(default='{}'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MenuItem.view_options'
        db.delete_column('cyclope_menuitem', 'view_options')
