...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.enable_comments_notifications'
        db.add_column('cyclope_sitesettings', 'enable_comments_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteSettings.enable_comments_notifications'
        db.delete_column('cyclope_sitesettings', 'enable_comments_notifications')
