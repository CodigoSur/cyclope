...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.favicon_image'
        db.add_column('cyclope_sitesettings', 'favicon_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteSettings.favicon_image'
        db.delete_column('cyclope_sitesettings', 'favicon_image')
    ...
    models = {
        ...
        'cyclope.sitesettings': {
            ...
            'color_a': ('django.db.models.fields.CharField', [], {'default': "'eee'", 'max_length': '8'}),
            'color_b': ('django.db.models.fields.CharField', [], {'default': "'ccc'", 'max_length': '8'}),
            'color_c': ('django.db.models.fields.CharField', [], {'default': "'999'", 'max_length': '8'}),
            'color_d': ('django.db.models.fields.CharField', [], {'default': "'666'", 'max_length': '8'}),
            'color_e': ('django.db.models.fields.CharField', [], {'default': "'333'", 'max_length': '8'}),
