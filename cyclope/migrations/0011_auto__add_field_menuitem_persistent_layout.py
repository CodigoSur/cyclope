...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MenuItem.persistent_layout'
        db.add_column('cyclope_menuitem', 'persistent_layout', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MenuItem.persistent_layout'
        db.delete_column('cyclope_menuitem', 'persistent_layout')
