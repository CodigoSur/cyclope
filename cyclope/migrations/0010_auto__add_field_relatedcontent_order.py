...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RelatedContent.order'
        db.add_column('cyclope_relatedcontent', 'order', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'RelatedContent.order'
        db.delete_column('cyclope_relatedcontent', 'order')
