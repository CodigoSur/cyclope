...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        for type_name in media_types:
            db.rename_column('medialibrary_%s' % type_name, 'author', 'txt_author')
    ...
    models = {
        ...
        'medialibrary.document': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 5, 48, 32, 183314)'}),
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 5, 48, 32, 183385)', 'auto_now': 'True', 'blank': 'True'}),
