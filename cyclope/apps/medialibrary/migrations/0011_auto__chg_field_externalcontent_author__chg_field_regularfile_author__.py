...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExternalContent.author'
        db.alter_column('medialibrary_externalcontent', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Author'], null=True, on_delete=models.SET_NULL))

        # Changing field 'RegularFile.author'
        db.alter_column('medialibrary_regularfile', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Author'], null=True, on_delete=models.SET_NULL))

        # Changing field 'FlashMovie.author'
        db.alter_column('medialibrary_flashmovie', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Author'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Document.author'
        db.alter_column('medialibrary_document', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Author'], null=True, on_delete=models.SET_NULL))

        # Changing field 'MovieClip.author'
        db.alter_column('medialibrary_movieclip', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Author'], null=True, on_delete=models.SET_NULL))

        # Changing field 'SoundTrack.author'
        db.alter_column('medialibrary_soundtrack', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Author'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Picture.author'
        db.alter_column('medialibrary_picture', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Author'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'ExternalContent.author'
        db.alter_column('medialibrary_externalcontent', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Author'], null=True))

        # Changing field 'RegularFile.author'
        db.alter_column('medialibrary_regularfile', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Author'], null=True))

        # Changing field 'FlashMovie.author'
        db.alter_column('medialibrary_flashmovie', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Author'], null=True))

        # Changing field 'Document.author'
        db.alter_column('medialibrary_document', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Author'], null=True))

        # Changing field 'MovieClip.author'
        db.alter_column('medialibrary_movieclip', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Author'], null=True))

        # Changing field 'SoundTrack.author'
        db.alter_column('medialibrary_soundtrack', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Author'], null=True))

        # Changing field 'Picture.author'
        db.alter_column('medialibrary_picture', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Author'], null=True))
