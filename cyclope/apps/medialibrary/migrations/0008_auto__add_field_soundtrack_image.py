...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SoundTrack.image'
        db.add_column('medialibrary_soundtrack', 'image', self.gf('filebrowser.fields.FileBrowseField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SoundTrack.image'
        db.delete_column('medialibrary_soundtrack', 'image')
    ...
    models = {
        ...
        'medialibrary.document': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 10, 22, 10, 32, 68830)'}),
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 10, 22, 10, 32, 69022)', 'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250', 'db_index': 'True'}),
