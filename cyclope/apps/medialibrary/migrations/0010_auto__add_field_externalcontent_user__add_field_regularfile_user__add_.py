...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExternalContent.user'
        db.add_column('medialibrary_externalcontent', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'RegularFile.user'
        db.add_column('medialibrary_regularfile', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'FlashMovie.user'
        db.add_column('medialibrary_flashmovie', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Document.user'
        db.add_column('medialibrary_document', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MovieClip.user'
        db.add_column('medialibrary_movieclip', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'SoundTrack.user'
        db.add_column('medialibrary_soundtrack', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Picture.user'
        db.add_column('medialibrary_picture', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExternalContent.user'
        db.delete_column('medialibrary_externalcontent', 'user_id')

        # Deleting field 'RegularFile.user'
        db.delete_column('medialibrary_regularfile', 'user_id')

        # Deleting field 'FlashMovie.user'
        db.delete_column('medialibrary_flashmovie', 'user_id')

        # Deleting field 'Document.user'
        db.delete_column('medialibrary_document', 'user_id')

        # Deleting field 'MovieClip.user'
        db.delete_column('medialibrary_movieclip', 'user_id')

        # Deleting field 'SoundTrack.user'
        db.delete_column('medialibrary_soundtrack', 'user_id')

        # Deleting field 'Picture.user'
        db.delete_column('medialibrary_picture', 'user_id')
    ...
    models = {
        ...
        'medialibrary.document': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 20, 0, 0)'}),
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 20, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250', 'db_index': 'True'}),
