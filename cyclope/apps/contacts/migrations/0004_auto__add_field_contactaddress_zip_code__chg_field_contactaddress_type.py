...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactAddress.zip_code'
        db.add_column('contacts_contactaddress', 'zip_code', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)

        # Changing field 'ContactAddress.type'
        db.alter_column('contacts_contactaddress', 'type', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Deleting field 'ContactAddress.zip_code'
        db.delete_column('contacts_contactaddress', 'zip_code')

        # Changing field 'ContactAddress.type'
        db.alter_column('contacts_contactaddress', 'type', self.gf('django.db.models.fields.CharField')(max_length=1))
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 25, 19, 30, 41, 252466)'}),
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 25, 19, 30, 41, 252621)', 'auto_now': 'True', 'blank': 'True'}),
