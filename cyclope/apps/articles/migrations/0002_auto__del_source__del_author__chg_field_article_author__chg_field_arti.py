...
class Migration(SchemaMigration):
    ...
    needed_by = (
        ("cyclope", "0002_auto__add_author__add_source"),
    )

    def forwards(self, orm):

        # Moving model 'Source'
        db.rename_table('articles_source', 'cyclope_source')

        # Moving model 'Author'
        db.rename_table('articles_author', 'cyclope_author')

        # Changing field 'Article.author'
        db.alter_column('articles_article', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Author']))

        # Changing field 'Article.source'
        db.alter_column('articles_article', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyclope.Source'], null=True, blank=True))


    def backwards(self, orm):

        # Moving model 'Source'
        db.rename_table('cyclope_source', 'articles_source')

        # Moving model 'Author'
        db.rename_table('cyclope_author', 'articles_author')

        # Changing field 'Article.author'
        db.alter_column('articles_article', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['articles.Author']))

        # Changing field 'Article.source'
        db.alter_column('articles_article', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['articles.Source'], null=True, blank=True))
