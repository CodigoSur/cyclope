...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArticleImageData.label'
        db.alter_column('articles_articleimagedata', 'label', self.gf('django.db.models.fields.CharField')(max_length=250))


    def backwards(self, orm):

        # Changing field 'ArticleImageData.label'
        db.alter_column('articles_articleimagedata', 'label', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True))
