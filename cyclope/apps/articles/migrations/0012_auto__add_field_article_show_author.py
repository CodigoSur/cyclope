...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.show_author'
        db.add_column('articles_article', 'show_author',
                      self.gf('django.db.models.fields.CharField')(default='SITE', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.show_author'
        db.delete_column('articles_article', 'show_author')
