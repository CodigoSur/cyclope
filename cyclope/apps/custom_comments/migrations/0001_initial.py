...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('custom_comments_customcomment', (
            ('threadedcomment_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['threadedcomments.ThreadedComment'], unique=True, primary_key=True)),
            ('subscribe', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('custom_comments', ['CustomComment'])


    def backwards(self, orm):
        # Deleting model 'CustomComment'
        db.delete_table('custom_comments_customcomment')
    ...
    models = {
        ...
        'custom_comments.customcomment': {
            'Meta': {'ordering': "('tree_path',)", 'object_name': 'CustomComment', '_ormbases': ['threadedcomments.ThreadedComment']},
            'subscribe': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'threadedcomment_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['threadedcomments.ThreadedComment']", 'unique': 'True', 'primary_key': 'True'})
        },
        'sites.site': {
