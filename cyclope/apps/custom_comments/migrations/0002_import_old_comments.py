...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for com in orm['comments.Comment'].objects.all():
            cc = orm.CustomComment()
            attrs = ["object_pk", "content_type", "site", "user", "user_name",
                     "user_email", "comment", "submit_date", "ip_address",
