...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('newsletter_newsletter', (
            ...
            ('last_sent_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('content_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collections.Category'])),
            ...
            ('test_recipients', self.gf('django.db.models.fields.CharField')(max_length=255)),
