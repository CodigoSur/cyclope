...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feed.titles_only'
        db.add_column('feeds_feed', 'titles_only', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feed.titles_only'
        db.delete_column('feeds_feed', 'titles_only')
    ...
    models = {
        ...
        'feeds.feed': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 23, 19, 27, 53, 430888)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 23, 19, 27, 53, 430974)', 'auto_now': 'True', 'blank': 'True'}),
