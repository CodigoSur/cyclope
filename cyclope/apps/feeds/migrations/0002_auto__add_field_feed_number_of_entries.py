...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feed.number_of_entries'
        db.add_column('feeds_feed', 'number_of_entries', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feed.number_of_entries'
        db.delete_column('feeds_feed', 'number_of_entries')
    ...
    models = {
        ...
        'feeds.feed': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 23, 18, 36, 20, 677285)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 23, 18, 36, 20, 677350)', 'auto_now': 'True', 'blank': 'True'}),
