...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaticPage.show_author'
        db.add_column('staticpages_staticpage', 'show_author',
                      self.gf('django.db.models.fields.CharField')(default='SITE', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StaticPage.show_author'
        db.delete_column('staticpages_staticpage', 'show_author')
