...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('staticpages_htmlblock', (
        ...
        db.send_create_signal('staticpages', ['HTMLBlock'])

        # Changing field 'StaticPage.creation_date'
        db.alter_column('staticpages_staticpage', 'creation_date', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Deleting model 'HTMLBlock'
        db.delete_table('staticpages_htmlblock')

        # Changing field 'StaticPage.creation_date'
        db.alter_column('staticpages_staticpage', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'staticpages.staticpage': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 23, 10, 52, 18, 573924)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 23, 10, 52, 18, 573988)', 'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250', 'db_index': 'True'}),
