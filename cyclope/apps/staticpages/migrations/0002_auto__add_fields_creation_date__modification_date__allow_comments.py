...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StaticPage.creation_date'
        db.add_column('staticpages_staticpage', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now(), auto_now_add=True, blank=True), keep_default=False)

        # Adding field 'StaticPage.modification_date'
        db.add_column('staticpages_staticpage', 'modification_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now(), auto_now=True, blank=True), keep_default=False)

        # Adding field 'StaticPage.allow_comments'
        db.add_column('staticpages_staticpage', 'allow_comments', self.gf('django.db.models.fields.CharField')(default='SITE', max_length=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StaticPage.creation_date'
        db.delete_column('staticpages_staticpage', 'creation_date')

        # Deleting field 'StaticPage.modification_date'
        db.delete_column('staticpages_staticpage', 'modification_date')

        # Deleting field 'StaticPage.allow_comments'
        db.delete_column('staticpages_staticpage', 'allow_comments')
