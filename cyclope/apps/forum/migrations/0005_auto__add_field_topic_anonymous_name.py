...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.anonymous_name'
        db.add_column('forum_topic', 'anonymous_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.anonymous_name'
        db.delete_column('forum_topic', 'anonymous_name')
    ...
    models = {
        ...
        'forum.topic': {
            ...
            'anonymous_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
