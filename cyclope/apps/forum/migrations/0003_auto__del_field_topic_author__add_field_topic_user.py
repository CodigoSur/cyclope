...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('forum_topic', 'author_id')

        # Adding field 'Topic.user'
        db.add_column('forum_topic', 'user',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Topic.author'
        raise RuntimeError("Cannot reverse this migration. 'Topic.author' and its values cannot be restored.")
        # Deleting field 'Topic.user'
        db.delete_column('forum_topic', 'user_id')
    ...
    models = {
        ...
        'forum.topic': {
            'Meta': {'ordering': "('-creation_date',)", 'object_name': 'Topic'},
